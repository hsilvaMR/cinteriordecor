...
<? include '_header.php';?>
<article>
	<? $sep=6; $sub=6.1; include '_menu.php';?>
	<div class="conteudo">
		<div class="linha">
			<div class="titulo">
				<h1>Todas as Essências<!--<a href="/admin/homepage"><small>nova homepage</small></a>--><h1>
		...
		<div class="linha">
			<? $numero=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM essencia"));
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM essencia"));
			...
			<? $numero=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM essencia"));
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM essencia WHERE online='1'"));
			$percentagem=round($num_per*100/$numero); ?>
			<div class="coluna2">
				<div class="corpo">
					<div class="linha">
		...
		<div class="linhaScroll">
			<div class="coluna1">
				<div class="corpo tabelaBorda">
					<div class="tabelaHead">ESSÊNCIAS</div>
					<div class="linhaScroll">
						<table id="sortable" class="listagem">
							...
							<tbody>
                            <? $risca=1;
                            $query = mysqli_query($lnk,"SELECT * FROM essencia");
							while($linha = mysqli_fetch_array($query))
							{
	                            ...
	                            <tr id="linha_<? echo $id?>" class="<? echo $classe?>">
									...
									<td>
										<a href="/admin/essencia/<?echo $id;?>" class="opcoes"><span class="lnr lnr-pencil"></span>&nbsp;Editar</a>&nbsp;&nbsp;
					...
					<button class="btV margin-top20 floatr" onClick="window.location.href='/admin/essencia';">ADICIONAR NOVO</button>
					<div class="clear"></div>
				</div>
			</div>
		</div>
...
function onoff(id){
	$.post("/admin/funcao/js_onoff.php",{ id:id, tabela:'essencia', campo:'online' })
	$.notific8('Guardado com sucesso.', {heading: 'Guardado'});	
}
function apagar(){
	$.post("/admin/funcao/js_delfoto.php",{ id:id_del, tabela:'essencia', campo:'img' }) 
    .done(function( data ){
