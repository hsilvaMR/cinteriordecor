...
<? include '_header.php';?>
<article>
	<? $sep=17; $sub=17.1; include '_menu.php';?>
	<div class="conteudo">
		<div class="linha">
			<div class="titulo">
				<h1>Todos os Vales de Desconto<!--<a href="/admin/homepage"><small>nova homepage</small></a>--><h1>
...
function apagar(){
	$.post("/admin/funcao/js_del.php",{ id:id_del, tabela:'vales_desconto' }) 
    .done(function( data ){
