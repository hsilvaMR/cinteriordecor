...
<? include '_header.php';?>
<article>
	<? $sep=4; $sub=4.3; include '_menu.php';?>
	<div class="conteudo">
		<div class="linha">
			<div class="titulo">
		...
		<div class="linha">
			...
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM produto_cat"));
							...
							while($linha = mysqli_fetch_array($query))
							{
	                            ...
	                            <tr id="linha_<? echo $id?>" class="<? echo $classe?>">
									...
									<td>
										...
										<a href="/admin/produtos/<?echo $id;?>" class="opcoes"><span class="lnr lnr-diamond"></span>&nbsp;Produtos</a>&nbsp;&nbsp;
...
function onoff(id){
	$.post("/admin/funcao/js_onoff.php",{ id:id, tabela:'produto_cat', campo:'online' })
	$.notific8('Guardado com sucesso.', {heading: 'Guardado'});	 	
}
function apagar(){
	$.post("/admin/funcao/js_del.php",{ id:id_del, tabela:'produto_cat' }) 
    .done(function( data ){
