...
var markersData = [
  {
      lat: 41.557285,
      lng: -8.414971,
      nome: "Ci interior decor",
      morada:"Rua de S.Domingos, 178",
      codPostal: "4710-435 Braga" // não colocar virgula no último item de cada marcador
   },
   {
      lat: 41.148417,
      lng: -8.637711,
      nome: "Ci interior decor",
      morada:"Rua do Ouro, 384",
      //morada2: "",
      codPostal: "4150-553 Porto" // não colocar virgula no último item de cada marcador
...
function displayMarkers(){
   ...
   for (var i = 0; i < markersData.length; i++){
      ...
      var morada = markersData[i].morada;
      var codPostal = markersData[i].codPostal;

      createMarker(latlng, nome, morada, codPostal);
...
function createMarker(latlng, nome, morada, codPostal){
   ...
   google.maps.event.addListener(marker, 'click', function() {
      ...
      var iwContent = '<div id="iw_container">' +
         ...
         '<div class="iw_content">' + morada + '<br />' +
         codPostal + '</div></div>';
