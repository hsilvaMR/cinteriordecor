...
if($email){
	...
	if($num_util == 1)
	{
		...
		mysqli_query($lnk,"INSERT INTO user_password (email, token, data) VALUES ('$email', '$token','$data')");
		...
		if($LANG=='pt'){
			$hello = "Olá";
			$hello_tx = "Para definir uma nova password, aceda a este link:";
			$pass_tx = "DEFINIR PASSWORD";
		...
		if($LANG=='en'){
			$hello = "Hello";
			$hello_tx = "To define a new password, access this link:";
			$pass_tx = "SET PASSWORD";
	...
	<body style="width:100%;background-color:#96C7D0;margin:0;padding:0;font-size:14px;-webkit-font-smoothing:antialiased;cursor:default;color:#222222;">
			  ...
			  <tr>
				<td align="center" width="400">
				  <table align="center" border="0" cellpadding="0" cellspacing="0" width="400">
				    <tbody>
				      <tr>
					    <td width="400" align="center" style="color:#000000;font-size: 15px;line-height: 24px;font-family:Open Sans;font-style: normal;font-weight: normal;">'.$hello.', <span style="color:#96C7D0;">'.$nome.'</span> <br> '.$hello_tx.' </td>
					  </tr>
					</tbody>
				  </table>
			    </td>
		...
		<table bgcolor="#fff" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="table-layout: fixed; vertical-align: top; min-width: 400px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff; width: 100%;padding-top:40px;" valign="top" width="100%">
			...
			<tr style="vertical-align: top;" valign="top" align="center">
				<td style="word-break: break-word; vertical-align: top; border-collapse: collapse;" valign="top">	
					...
					<!--<![endif]-->
					<div align="center" class="button-container" style="padding-top:0px;padding-right:30px;padding-bottom:30px;padding-left:30px;width:150px;">
					<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 0px; padding-right: 30px; padding-bottom: 30px; padding-left: 30px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.ci-interiordecor.com/nova-password/'.$token.'" style="height:31.5pt; width:150pt; v-text-anchor:middle;" arcsize="96%" stroke="false" fillcolor="#4197A6"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:\'Open Sans\',sans-serif;font-weight: 300; font-size:14px"><![endif]-->
					<a href="http://www.ci-interiordecor.com/nova-password/'.$token.'" target="_blank"><div style="text-decoration:none;display:block;color:#ffffff;background-color:#4197A6;border-radius:25px;-webkit-border-radius:25px;-moz-border-radius:25px;width:100%; width:calc(100% - 2px);;border-top:1px solid #4197A6;border-right:1px solid #4197A6;border-bottom:1px solid #4197A6;border-left:1px solid #4197A6;padding-top:5px;padding-bottom:5px;font-family:\'Open Sans\',sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;font-weight: 300;">
						<span style="padding-left:5px;padding-right:5px;font-size:16px;display:inline-block;">
						<span style="font-size:14px;line-height:32px;color:#ffffff;">'.$pass_tx.'</span>
						</span>
					</div></a>
				    ...
				    <tbody>
				      <tr>
					    <td width="400" align="center" style="font-family:\'Open Sans\',sans-serif;font-style:normal;font-weight:300;font-size: 10px;line-height:14px;color:#96C7D0;">
					    	<a href="http://www.ci-interiordecor.com" style="text-decoration:none;color:#96C7D0;">www.ci-interiordecor.com</a>
						</td>
					  </tr>
					</tbody>
				  </table>
		...
		<table style="background-color:#fff;padding-top:10px;" border="0" cellpadding="0" width="100%">
			<tbody>
			  <tr>
				<td align="center" width="400">
					<a href="https://www.facebook.com/ci.interiordecor" target="_bank"><img src="http://www.ci-interiordecor.com/img/emails/facebook.png" alt="facebook" height="12" width="12" style="margin-right:10px;"></a>&ensp;
					<a href="https://www.pinterest.pt/cidecor/" target="_bank"><img src="http://www.ci-interiordecor.com/img/emails/pintrest.png" alt="pintrest" height="12" width="12" style="margin-right:10px;"></a>&ensp;
					<a href="https://www.instagram.com/ci.interiordecor/" target="_bank"><img src="http://www.ci-interiordecor.com/img/emails/instagram.png" alt="instagram" height="12" width="12"></a>
			    </td>
			  </tr>
			</tbody>
		</table>
	...
	';
		...
		if($LANG=='pt'){
			$retorna['aviso'] = "Email inexistente."; $aviso = 1;
		}

		if($LANG=='en'){
			$retorna['aviso'] = "Email does not exist."; $aviso = 1;
		}
	}
}else{ 
	
	if($LANG=='pt'){
		$retorna['aviso'] = "Insira corretamente o email."; $aviso = 1;
	}

	if($LANG=='en'){
		$retorna['aviso'] = "Enter the email correctly."; $aviso = 1;
	}
}
